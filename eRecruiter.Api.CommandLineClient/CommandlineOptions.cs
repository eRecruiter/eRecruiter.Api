...
namespace eRecruiter.Api.CommandLineClient
{
    public class CommandlineOptions
    {
        ...
        [Option("RunAgnosticApplicantsByGlobalIdRequest", Required = false, HelpText = "Whether or not to run request to get mandator-agnostic applicant info from global IDs.")]
        public bool RunAgnosticApplicantsByGlobalIdRequest { get; set; }
